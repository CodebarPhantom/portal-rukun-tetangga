                ...
                <div class="card-body grid gap-5">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                            ...
                            <input readonly="true" class="input" name="shift" type="text" value="{{$data['overtime']['shift']['name'] }}" />
                        </div>
                        <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                            <label class="form-label max-w-56">
                                Durasi Lembur
                            </label>
                            <input readonly="true" class="input" name="overtime_hour" placeholder="Durasi Lembur" type="number" min="1"
                    ...
                    <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                        ...
                        <input readonly="true" class="input" name="shift" type="text" value="{{ number_format($data['overtime']['overtime_pay'],0) }}" />
                    </div>
