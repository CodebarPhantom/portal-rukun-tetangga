...
@section('content')
    ...
    <div class="container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
            ...
            <div class="flex items-center gap-2.5">
                ...
                <a class="btn btn-sm text-center btn-success" href="{{ route('work-schedule.shift.create') }}">
                            ...
                            <table class="table table-auto table-border align-middle text-gray-700 font-medium text-sm"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" data-datatable-column="start_time">
                                            <span class="sort">
                                                <span class="sort-label">
                                                    Waktu Masuk
                                                </span>
                                        ...
                                        <th class="text-center" data-datatable-column="end_time">
                                            <span class="sort">
                                                <span class="sort-label">
                                                    Waktu Pulang
                                                </span>
                                        ...
                                        <th class="text-center" data-datatable-column="duration_hours">
                                            <span class="sort">
                                                <span class="sort-label">
                                                    Durasi Jam
                                                </span>
                                        ...
                                        <th class="text-center" data-datatable-column="night_shift">
                                            <span class="sort">
                                                <span class="sort-label">
    ...
    @include('partials.modal-confirm-delete', [
        'mainTitle' => 'Hapus shift?',
        'mainContent' => 'Apakah anda yakin untuk menghapus shift ini?',
    ])
@endsection
...
@push('javascript')
    ...
    <script type="text/javascript">
        const showRoute = "{{ route('work-schedule.shift.show', ':id') }}"; // Pass route pattern to JS
        const editRoute = "{{ route('work-schedule.shift.edit', ':id') }}"; // Pass route pattern to JS
    </script>
    <!-- End - Define Route -->

    <script type="text/javascript">
        const apiUrl = '{{ route('api.v1.work-schedule.shift.datatable') }}';
        const deleteUrl = "{{ route('api.v1.work-schedule.shift.destroy', ':id') }}";
            ...
            columns: {
                ...
                duration_hours: {
                    ...
                    render: (data, type, row) => {
                        return `${type.duration_hours} Jam`;
                    },
                    createdCell(cell) {
                        cell.classList.add('text-center');
                    },
                ...
                is_night_shift: {
                    title: 'Jam Masuk dan Jam Keluar Berbeda Hari?',
                    createdCell(cell) {
                        cell.classList.add('text-center');
                    },
                    render: (item, row, context) => {
                        return item ?
                            `<span class="badge badge-outline badge-pill badge-dark">Yes</span>` :
                            `<span class="badge badge-outline badge-pill badge-primary">No</span>`;
                    },
