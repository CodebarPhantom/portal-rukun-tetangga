        ...
        <div class="container-fixed">
            <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                ...
                <div class="flex items-center gap-2.5">
                    ...
                    @if ($data['shiftRotating']['already_generated'] == false)
                    <div class="flex items-center gap-2.5">
                        <a class="btn btn-sm text-center btn-warning" href="{{ route('work-schedule.shift-rotating.edit', $data['shiftRotating']['id']) }}">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            ...
                            <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                ...
                                <input class="input" name="end_date" placeholder="mm/dd/yyyy" type="date" readonly="true"
                                    value="{{ old('end_date',$data['shiftRotating']['end_date']) }}" />
                            </div>
                        </div>
