...
@section('content')
    ...
    <div class="container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
            ...
            <div class="flex items-center gap-2.5">
                ...
                <a class="btn btn-sm text-center btn-success" href="{{ route('work-schedule.holiday.create') }}">
                            ...
                            <table class="table table-auto table-border align-middle text-gray-700 font-medium text-sm"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" data-datatable-column="holiday_roles_count">
                                            <span class="sort">
                                                <span class="sort-label">
                                                    Jabatan Libur
                                                </span>
    ...
    @include('partials.modal-confirm-delete', [
        'mainTitle' => 'Hapus tanggal?',
        'mainContent' => 'Apakah anda yakin untuk menghapus tanggal ini?',
    ])
@endsection
...
@push('javascript')
    ...
    <script type="text/javascript">
        const showRoute = "{{ route('work-schedule.holiday.show', ':id') }}"; // Pass route pattern to JS
        const editRoute = "{{ route('work-schedule.holiday.edit', ':id') }}"; // Pass route pattern to JS
    </script>
    <!-- End - Define Route -->

    <script type="text/javascript">
        const apiUrl = '{{ route('api.v1.work-schedule.holiday.datatable') }}';
        const deleteUrl = "{{ route('api.v1.work-schedule.holiday.destroy', ':id') }}";
