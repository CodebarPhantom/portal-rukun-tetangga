        ...
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
            <div class="flex flex-col justify-center gap-2">
                ...
                <div class="flex items-center gap-2.5">
                    <a class="btn text-center btn-sm btn-primary" href="{{ route('workforce.submitted-form.overtime.index') }}">
                        <i class="ki-filled ki-left"></i></i>Kembali
                    </a>
                    @if ($data['overtime']['status']->value === 2)

                        <form action="{{ route('workforce.submitted-form.overtime.reject-overtime-update',$data['overtime']['id']) }}" method="POST" onsubmit="return rejectOVertime(event)" class="inline">
                            @csrf
                        ...
                        <div class="flex items-center gap-2.5">
                            <a class="btn btn-sm text-center btn-info"
                                href="{{ route('workforce.submitted-form.overtime.edit', $data['overtime']['id']) }}">
                                <i class="ki-filled ki-calculator"></i>{{ $data['editPageTitle'] }}
                            </a>
                        </div>
                    @endif
            </div>
