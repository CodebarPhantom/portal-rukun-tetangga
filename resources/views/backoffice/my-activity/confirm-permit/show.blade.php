        ...
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
            ...
            <div class="flex items-center gap-2.5">
                <a class="btn text-center btn-sm btn-primary"
                    href="{{ route('my-activity.my-permit-confirm.confirm-permit-index') }}">
                    <i class="ki-filled ki-left"></i></i>Kembali
                </a>
                @if ($data['permit']['status']->value === 1)
                    <form action="{{ route('my-activity.my-permit-confirm.confirm-permit-update', $data['permit']['id']) }}"
                        method="POST" onsubmit="return confirmPermitApproval(event)" class="inline">
                        @csrf
                        <input type="hidden" name="_method" value="PUT">
                        <button type="submit" class="btn text-center btn-sm btn-success" data-tooltip="#confirmLPermit">
                            <i class="ki-filled ki-check"></i> Setujui Izin
                        </button>
                    </form>

                    <form action="{{ route('my-activity.my-permit-confirm.reject-permit-update', $data['permit']['id']) }}"
            ...
            <div class="card pb-2.5">
                ...
                <div class="card-body">
                    <div class="flex flex-col">
                        ...
                        @endif
                        @if ($data['permit']['status']->value === LeaveStatus::DITOLAK->value)
                            <div class="flex items-start relative">
                                <div
                                    class="flex items-center justify-center shrink-0 rounded-full bg-gray-100 border border-gray-300 size-9 text-gray-600">
                        ...
                        @if ($data['permit']['status']->value === LeaveStatus::DIBATALKAN->value)
                            <div class="flex items-start relative">
                                <div
                                    class="flex items-center justify-center shrink-0 rounded-full bg-gray-100 border border-gray-300 size-9 text-gray-600">
