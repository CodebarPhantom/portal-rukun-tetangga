        ...
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
            ...
            <div class="flex items-center gap-2.5">
                <a class="btn text-center btn-sm btn-primary"
                    href="{{ route('my-activity.my-leave-confirm.confirm-leave-index') }}">
                    <i class="ki-filled ki-left"></i></i>Kembali
                </a>
                @if ($data['leave']['status']->value === 1)
                    <form action="{{ route('my-activity.my-leave-confirm.confirm-leave-update', $data['leave']['id']) }}"
                        method="POST" onsubmit="return confirmLeaveApproval(event)" class="inline">
                        @csrf
                    ...
                    <form action="{{ route('my-activity.my-leave-confirm.reject-leave-update', $data['leave']['id']) }}"
                        method="POST" onsubmit="return rejectLeave(event)" class="inline">
                        @csrf
                        <input type="hidden" name="_method" value="PUT">
