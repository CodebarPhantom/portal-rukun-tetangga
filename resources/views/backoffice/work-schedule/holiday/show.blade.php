    ...
    <div class="container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
            ...
            <div class="flex items-center gap-2.5">
                ...
                <div class="flex items-center gap-2.5">
                    <a class="btn btn-sm text-center btn-warning" href="{{ route('work-schedule.holiday.edit', $data['holiday']['id']) }}">
            ...
            <div class="card pb-2.5">
                ...
                <div class="card-body grid gap-5">
                    ...
                    <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                        ...
                        <input class="input" name="name" placeholder="Nama Hari Libur" type="text" readonly="true"
                            value="{{ old('name',$data['holiday']['name']) }}" />
                    </div>
                    ...
                    <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                        ...
                        <input class="input" name="date" placeholder="mm/dd/yyyy" type="date" readonly="true"
                            value="{{ old('date',$data['holiday']['date']) }}" />
                    </div>
                    ...
                    <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                        ...
                        <div class="relative inline-block w-full combobox"
                            ...
                            <input type="hidden" class="selected-data" name="roles" value="{{ $data['holidayRoleIdsString'] }}" />
                            <div
