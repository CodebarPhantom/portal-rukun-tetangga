...
@section('content')
    ...
    <div class="container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
            ...
            <div class="flex items-center gap-2.5">
                ...
                <a class="btn btn-sm text-center btn-success" href="{{ route('entity.create') }}">
    ...
    @include('partials.modal-confirm-delete', [
        'mainTitle' => 'Hapus entitas?',
        'mainContent' => 'Apakah anda yakin untuk menghapus entitas ini?',
    ])
@endsection
...
@push('javascript')
    ...
    <script type="text/javascript">
        const showRoute = "{{ route('entity.show', ':id') }}"; // Pass route pattern to JS
        const editRoute = "{{ route('entity.edit', ':id') }}"; // Pass route pattern to JS
    </script>
    <!-- End - Define Route -->

    <script type="text/javascript">
        const apiUrl = '{{ route('api.v1.entity.datatable') }}';
        const deleteUrl = "#";
