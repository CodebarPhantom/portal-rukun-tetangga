...
@section('content')
    ...
    <!-- Container -->
    <form action="{{ route('workforce.submitted-form.overtime.update', $data['overtime']['id']) }}" method="post">
        @csrf
        @method('PUT')
                ...
                <div class="flex items-center gap-2.5">
                    <div class="flex items-center gap-2.5">
                        <a class="btn text-center btn-sm btn-primary"
                            href="{{ route('workforce.submitted-form.overtime.index') }}">
                            <i class="ki-filled ki-left"></i></i>Kembali
                        </a>
                        <button type="submit" class="btn btn-sm text-center btn-info">
                            <i class="ki-filled ki-calculator"></i>{{ $data['pageTitle'] }}
                        </button>
                    </div>
                </div>
                    ...
                    <div class="card-body grid gap-5">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                ...
                                <input readonly="true" class="input" name="start_date" type="input"
                                    value="{{ $data['overtime']['formatted_start_date'] }}" />
                            </div>
                            <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                <label class="form-label max-w-56">
                                    Sampai
                                </label>
                                <input readonly="true" class="input" name="end_date" type="input"
                                    value="{{ $data['overtime']['formatted_end_date'] }}" />
                            </div>
                        </div>
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                ...
                                <div class="input-group">
                                    <input class="input" placeholder="Nominal Lembur" name="overtime_pay" type="number"
                                        value="" />
                                    <span class="btn btn-icon btn-icon-lg btn-input">
                                        <i class="ki-filled ki-calculator">
                                        </i>
                                    </span>
                                </div>
