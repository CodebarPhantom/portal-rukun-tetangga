...
@section('content')
    ...
    <div class="container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
            ...
            <div class="flex items-center gap-2.5">
                ...
                <a class="btn btn-sm text-center btn-success" href="{{ route('workforce.employee-payroll-deduction.create') }}">
    ...
    @include('partials.modal-confirm-delete', [
        'mainTitle' => 'Hapus Deduction?',
        'mainContent' => 'Apakah anda yakin untuk menghapus deduction ini?',
    ])
@endsection
...
@push('javascript')
    ...
    <script type="text/javascript">
        const showRoute = "{{ route('workforce.employee-payroll-deduction.show', ':id') }}";
        const editRoute = "{{ route('workforce.employee-payroll-deduction.edit', ':id') }}";
    </script>
    <!-- End - Define Route -->

    <script type="text/javascript">
        const apiUrl = '{{ route('api.v1.workforce.employee-payroll-deduction.datatable') }}';
        const deleteUrl = "{{ route('api.v1.workforce.employee-payroll-deduction.destroy', ':id') }}";
