...
@push('javascript')
    ...
    <script type="text/javascript">
        const showRoute = "{{ route('my-activity.my-leave-confirm.confirm-leave-show', ':id') }}"; // Pass route pattern to JS
        const editRoute = "{{ route('my-activity.my-leave-confirm.confirm-leave-update', ':id') }}"; // Pass route pattern to JS
        const rejectRoute = "{{ route('my-activity.my-leave-confirm.reject-leave-update', ':id') }}"; // Pass route pattern to JS
    ...
    <script type="text/javascript">
        const apiUrl = '{{ route('api.v1.my-activity.my-leave-confirm.datatable-confirm-leave') }}';
        const deleteUrl = '#';
            ...
            columns: {
                ...
                action: {
                    ...
                    render: (data, type, row) => {
                        ...
                        const buttonApprove = `
                            <form action="${editUrl}" method="POST" onsubmit="return confirmLeaveApproval(event)" class="inline">
                                @csrf
