        ...
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
            ...
            <div class="flex items-center gap-2.5">
                <a class="btn text-center btn-sm btn-primary"
                    href="{{ route('my-activity.my-business-trip-confirm.confirm-business-trip-index') }}">
                    <i class="ki-filled ki-left"></i></i>Kembali
                </a>
                @if ($data['businessTrip']['status']->value === 1)
                    <form action="{{ route('my-activity.my-business-trip-confirm.confirm-business-trip-update', $data['businessTrip']['id']) }}"
                    ...
                    <form action="{{ route('my-activity.my-business-trip-confirm.reject-business-trip-update', $data['businessTrip']['id']) }}"
                ...
                <div class="card-body grid gap-5">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                            ...
                            <span class="badge badge-pill badge-outline badge-{{ $data['businessTrip']['permit_type_color'] }}">
                                {{ $data['businessTrip']['permit_type_label'] }}
                            </span>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                            ...
                            <span class="badge badge-pill badge-outline badge-{{ $data['businessTrip']['status_color'] }}">
                                {{ $data['businessTrip']['status_label'] }}
                            </span>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
