...
class EmployeePayrollCombenController extends MasterController
{
    ...
    public function dataTable(Request $request)
    {
        ...
        $employees = EmployeePayrollComben::with(['employee'])
            ->join('employees', 'employee_payroll_combens.employee_id', '=', 'employees.id') // Join with employees table
            ...
            ->select('employee_payroll_combens.*') // Ensure correct columns are selected
            ->paginate($pageSize);
    ...
    public function destroy($id)
    {
        $func = function () use ($id) {
            ...
            $this->employeePayrollCombenService->deleteComben($id);
