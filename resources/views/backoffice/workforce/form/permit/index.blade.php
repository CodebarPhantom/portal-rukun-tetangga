    ...
    <div class="container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
            ...
            <div class="flex items-center gap-2.5">
                ...
                <a class="btn btn-sm text-center btn-success" href="{{ route('workforce.submitted-form.permit.create') }}">
...
@push('javascript')
    ...
    <script type="text/javascript">
        const confirmRoute = "{{ route('workforce.submitted-form.permit.confirm-permit-update', ':id') }}";
        const rejectRoute = "{{ route('workforce.submitted-form.permit.reject-permit-update', ':id') }}";
        //const editRoute = "{{ route('workforce.submitted-form.permit.edit', ':id') }}";
        const showRoute = "{{ route('workforce.submitted-form.permit.show', ':id') }}";
    ...
    <script type="text/javascript">
        const apiUrl = '{{ route('api.v1.workforce.submitted-form.permit.dataTable') }}';
        const deleteUrl = "#";
            ...
            columns: {
                ...
                action: {
                    ...
                    render: (data, type, row) => {
                        ...
                        // const buttonApprove = `
                        //     <form action="${confirmUrl}" method="POST" onsubmit="return confirmPermitApproval(event)" class="inline">
                        //         @csrf
                        ...
                        const buttonReject = `
                            <form action="${rejectUrl}" method="POST" onsubmit="return rejectPermit(event)" class="inline">
                                @csrf
                                <input type="hidden" name="_method" value="PUT">
                                <button type="submit" class="btn btn-icon btn-sm btn-clear btn-danger" data-tooltip="#rejectPermit${type.id}">
                                    <i class="ki-filled ki-cross"></i>
                                </button>
                            </form>
                            <div class="tooltip transition-opacity duration-300" id="rejectPermit${type.id}">
