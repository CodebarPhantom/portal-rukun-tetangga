    ...
    <div class="container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
            ...
            <div class="flex items-center gap-2.5">
                ...
                <a class="btn btn-sm text-center btn-success" href="{{ route('departement.create') }}">
                            ...
                            <table class="table table-auto table-border align-middle text-gray-700 font-medium text-sm"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="w-1/6 text-center" data-datatable-column="division">
                                            <span class="sort">
                                                <span class="sort-label">
                                                    Divisi
                                                </span>
                                        ...
                                        <th class="w-1/12 text-center" data-datatable-column="is_active">
                                            <span class="sort">
                                                <span class="sort-label">
                                                    is Active
                                                </span>
...
@push('javascript')
    ...
    <script type="text/javascript">
        const showRoute = "{{ route('departement.show', ':id') }}"; // Pass route pattern to JS
        const editRoute = "{{ route('departement.edit', ':id') }}"; // Pass route pattern to JS
    </script>
    <!-- End - Define Route -->

    <script type="text/javascript">
        const apiUrl = '{{ route('api.v1.departement.datatable') }}';
        const deleteUrl = "{{ route('api.v1.departement.destroy', ':id') }}";
        ...
        const refreshTable = document.getElementById('refresh-btn').addEventListener('click', function() {
            ...
            // Refresh the DataTable (assuming your DataTable has a method to reload or refresh)

            dataTable.reload(); // or dataTable.refresh() depending on your library method
        });
    </script>
@endpush
