...
@section('content')
    ...
    <!-- Container -->
    <form action="{{ route('workforce.submitted-form.permit.store') }}" method="post">
        @csrf
                ...
                <div class="flex items-center gap-2.5">
                    <div class="flex items-center gap-2.5">
                        ...
                        <a class="btn text-center btn-sm btn-primary"
                            href="{{ route('workforce.submitted-form.permit.index') }}">
                    ...
                    <div class="card-body grid gap-5">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                ...
                                <input class="input" name="start_date" placeholder="mm/dd/yyyy" type="datetime-local" value="" />
                            </div>
                            <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                <label class="form-label max-w-56">
                                    Sampai
                                </label>
                                <input class="input" name="end_date" placeholder="mm/dd/yyyy" type="datetime-local" value="" />
                            </div>
                        </div>
                        <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                            <label class="form-label max-w-56">
