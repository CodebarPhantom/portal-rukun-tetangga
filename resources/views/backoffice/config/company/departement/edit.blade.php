...
@section('content')
    ...
    <!-- Container -->
    <form action="{{ route('departement.update',$data['departement']['id']) }}" method="post">
        @csrf
        @method('PUT')
                ...
                <div class="card pb-2.5">
                    <div class="card-body grid gap-5">
                        <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                            ...
                            <select class="select" name="division_id">
                        ...
                        <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                            ...
                            <input class="input" name="name" placeholder="Nama Departemen" type="text"
