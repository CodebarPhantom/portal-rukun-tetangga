    ...
    <div class="container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
            ...
            <div class="flex items-center gap-2.5">
                ...
                <a class="btn btn-sm text-center btn-success"
                    href="{{ route('workforce.submitted-form.overtime.create') }}">
...
@push('javascript')
    ...
    <script type="text/javascript">
        const confirmRoute = "{{ route('workforce.submitted-form.overtime.confirm-overtime-update', ':id') }}";
        const rejectRoute = "{{ route('workforce.submitted-form.overtime.reject-overtime-update', ':id') }}";
        const editRoute = "{{ route('workforce.submitted-form.overtime.edit', ':id') }}";
        const showRoute = "{{ route('workforce.submitted-form.overtime.show', ':id') }}";
    </script>
    <!-- End - Define Route -->
    ...
    <script type="text/javascript">
        const apiUrl = '{{ route('api.v1.workforce.submitted-form.overtime.dataTable') }}';
        const deleteUrl = "#";
            ...
            columns: {
                ...
                action: {
                    ...
                    render: (data, type, row) => {
                        ...
                        const buttonEdit = `
                            <a href="${editUrl}" class="btn btn-icon btn-sm btn-clear btn-info" data-tooltip="#edit${type.id}">
                                <i class="ki-filled ki-calculator"></i>
                            </a>
                            <div class="tooltip transition-opacity duration-300" id="edit${type.id}">
                                Hitung {{ $data['pageTitle'] }}
                            </div>
                        `;

                        // const buttonApprove = `
                        //     <form action="${confirmUrl}" method="POST" onsubmit="return confirmOvertimeApproval(event)" class="inline">
                        //         @csrf
                        //         <input type="hidden" name="_method" value="PUT">
                        //         <button type="submit" class="btn btn-icon btn-sm btn-clear btn-success" data-tooltip="#confirmOVertime">
                        //             <i class="ki-filled ki-check"></i>
                        //         </button>
                        //     </form>
                        //     <div class="tooltip transition-opacity duration-300" id="confirmOVertime">
                        ...
                        <div class="items-center space-x-2">
                            ${buttonShow}  ${type.status ===  2 ? buttonEdit+buttonReject : ''}
                        </div>
                    `;
                    },
                    createdCell(cell) {
